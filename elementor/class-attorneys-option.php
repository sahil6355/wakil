...
if (is_plugin_active('elementor/elementor.php')) {
    ...
    class simple_attorneys_Widget extends \Elementor\Widget_Base {
        public function get_name()
        {
            return 'custom-attorneys-widget';
        }
        public function get_title()
        {
            return esc_html__('Custom Attorneys', 'wakil');
        }
        ...
        protected function render() {
            ...
            if ($settings['select_option'] == 'option1') {
             ...
             ?>
             <div class="Attorneys Attorneys2">
                <?php 
                if ($query -> have_posts()) : 
